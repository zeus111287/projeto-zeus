...
def verificar_senha():
    def conferir():
        if st.session_state["usuario"] == "zeus" and st.session_state["senha"] == "1234": # VOCÊ PODE MUDAR A SENHA AQUI
